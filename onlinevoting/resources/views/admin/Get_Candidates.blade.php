  ...
  <html lang="en">
    ...
    <body>
      ...
      <div style="position: relative; top:60px; right:-150px">
        ...
        <form action="{{url('upload_candidate')}}" method="POST" enctype="multipart/form-data">
          <div class="form-group">

          @csrf
        <div>
         <label>Position ID:</label>
         <input class="form-control" style="color: blue" type="text"  name="position_id" placeholder="Position ID" required> 
        ...
        <div>
           ...
           <div>
            ...
            <input class="form-control" style="color: blue" type="text"  name="platform" placeholder="Platform" required> 
      ...
      <div style="background-color: black">
        ...
        <tr align="center">
         <th style="padding: 30px">Position Name</th>
         ...
         <th style="padding: 30px">Platform</th>
         ...
         <th style="padding: 30px">Update</th>
          ...
          @foreach ($data as $datas)
              <tr>
               ...
               <td style="padding: 30px"><img class="img-rounded" alt="Cinque Terre" width="304" height="236" src="/candidateimage/{{$datas->image}}"> </td>

               <td style="padding: 30px"> {{$datas->platform}} </td>
